...
class AriisAnalyticContractLine(models.Model):
    _name = 'ariis.analytic.contract.line'
    _description = 'Ariis Contract Lines'
    _order = "sequence,id"
